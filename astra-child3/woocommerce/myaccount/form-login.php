...
<div class="khoshtip-auth-container">
    ...
    <!-- حذف شده: بررسی enable_myaccount_registration و ساختار دو ستونی -->
    <div class="khoshtip-auth-panel khoshtip-auth-panel-single">

            <h2 class="khoshtip-auth-title">ورود به حساب کاربری</h2>
            <p class="khoshtip-auth-subtitle">به فروشگاه خوش‌تیپ کوچولو خوش آمدید</p>
...
<!-- اضافه شده: مودال درخواست شماره موبایل برای کاربران Google -->
<div id="phone-request-modal" class="khoshtip-modal" style="display: none;">
    <div class="khoshtip-modal-content">
        <h3>تکمیل پروفایل</h3>
        <p>لطفاً شماره موبایل خود را وارد کنید:</p>
        <input type="tel" id="phone-request-input" placeholder="09123456789" maxlength="11" pattern="[0-9]{11}">
        <button id="submit-phone-request" class="woocommerce-button button">ثبت شماره موبایل</button>
        <p class="phone-request-error" style="display: none; color: #e53e3e; margin-top: 10px;"></p>
    </div>
</div>
